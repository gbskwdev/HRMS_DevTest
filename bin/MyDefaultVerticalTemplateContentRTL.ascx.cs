...
namespace HCM10.Web
{
    public partial class MyDefaultVerticalTemplateContentRTL : TemplateContent, IXafPopupWindowControlContainer, IXafSecurityActionContainerHolder, IHeaderImageControlContainer
    {
        static MyDefaultVerticalTemplateContentRTL()
        {
        ...
        {
            base.OnInit(e);
            HeaderImageControl.DefaultThemeImageLocation = "~/Images";
            HeaderImageControl.ImageName = "Logo.png";
        }
        private void CurrentRequestWindow_PagePreRender(object sender, EventArgs e)
        {
            ...
            DevExpress.Web.ASPxNavBar navBar = this.NC.NavigationControl as DevExpress.Web.ASPxNavBar;
            if (navBar != null)
            {
                navBar.AutoCollapse = false;
                navBar.EnableAnimation = true;
                navBar.Height = Unit.Pixel(500);
                navBar.ClientSideEvents.HeaderClick = "function(s, e) { var expanded = e.group.GetExpanded();s.CollapseAll();e.group.SetExpanded(!expanded);e.cancel = true;}";
